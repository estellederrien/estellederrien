...
20 02 2026 : Je vais ajouter des notebooks en Français, différents de ceux en Anglais, afin de tester comment l'I.A se comporte avec un autre language . Pour l'instant, je teste toujours l'A.I. Priorité sur optimisations quadratiques, opt sous incertitudes,  eq différentielles,équations quadratiques, et reprise du M.L , mais ça permet d'acquérir des connaissances très rapidement, c'est un peu comme un turbo gigantesque, Je n'ai eu qu'un code 'inopérant' à voir dans mon notebook nl opt pt2 ( Pipelines optimisations), sur des tas de requêtes, et finalement, en changeant d'A.I, ça a resolu le pb.
