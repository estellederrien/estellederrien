...
faire en Anglais, cependant, je vais traduire automatiquement avec l'outil approprié dès que c'est à peu prêt fini. Vous pouvez déjà traduire mes notebooks en cours de création, en utilisant le logiciel python Jupiter notebook. Le notebook que je dois absolument faire est " Optimisations non linéaires", qui sera vraiment utile sur des problèmes réels, je suis en train de repérer des tas d'exemples concrets.
