...
30 01 2026 : Bonjour, je traduirais mes notebooks plus tard, de toute façon, je parie que chatGpt doit pouvoir le faire maintenant ( Je n'ai pas essayé.). Pour l'instant, je valide d'utiliser des LLMS pour synthétiser les exemples de base en recherche opérationnelle et d'autres choses. Les bases sont exceptionnellement bien récapitulées, comme dans aucun autre livre ou cours, par exemple, pour les équations différentielles. Il faut tout de même effectuer des comparatifs sur les résultats.
