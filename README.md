...
Bonjour, la méthode pour traduire un notebook python, est de l'exporter au format HTML avec le logiciel Jupiter Notebook, puis de le traduire dans chrome en faisant un click droit. Ou alors, essayer avec ChatGPT.


### <b>Latest news :</b>

20 02 2026 : Je vais ajouter des notebooks en Français, différents de ceux en Anglais, afin de tester comment ça se comporte avec un autre language . Pour l'instant, je teste toujours l'A.I. Priorité sur optimisations quadratiques, opt sous incertitudes,  eq différentielles,équations quadratiques, et reprise du M.L + Ode robotiques (hard) ensuite. J'aimerais refaire mon notebook " Probability laws" avec l'A.I afin de voir ce que ça dit. La puissance de l'A.I est excellente, enfin je dirais plutôt que c'est dément pour étudier... Pour l'instant, je n'ai pas le temps de regarder pour les domaines électricité, Thermodynamique, résistance matériaux etc.. Mais ça à l'air pas mal non plus.
