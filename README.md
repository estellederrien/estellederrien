...
08 01 2026 : I will also finish my O.R notebooks using ChatGpt and Gemini, I have just tested it today, and It's good, for exemple, a linear 3d bin packing code, all explained, in French language.
Another is a non linear item volume optimization using Scipy, dicrectly given by Chat GPT. What is good, is that I am now able to understand, and re create the math model, if ChatGpt does not create it in Latex , I 
am also able to test the furnished O.R codes. And yes, I should dev SolvGraph 100 times faster using theses O.R generated codes.
