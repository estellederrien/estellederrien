...
30 01 2026 : Bonjour, je traduirais mes notebooks plus tard, de toute façon, je parie que chatGpt doit pouvoir le faire maintenant ( Je n'ai pas essayé.). Pour l'instant, je valide d'utiliser des LLMS pour synthétiser les exemples de base en recherche opérationnelle et optimisations, et les autres univers. Les bases sont exceptionnellement bien récapitulées, comme dans aucun autre livre ou cours, par exemple, pour les équations différentielles. Il faut tout de même effectuer des comparatifs sur les résultats. Il subsiste toujours le mystère que cela a été entrainé sur des livres obscurs, et je ne vois pas comment cela peut apporter des réponses aussi claires, mais bon, on fera "Comme si". DeepSeek propose des réponses super longues sur les pbs non linéaires, et j'ai eu un code python qui provoquait une erreur ( Mais je n'ai fait que 2 essais)
